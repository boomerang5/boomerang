...
export async function GET(request: NextRequest) {
  try {
    ...
    const agrupacion = searchParams.get('agrupacion') || 'semana';
    ...
    const url = new URL(`${BACKEND_URL}/api/reports/productividad`);
    ...
    console.error('Error en API route productividad:', error);
    return NextResponse.json(
