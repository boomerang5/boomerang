  ...
  useEffect(() => {
    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-stretch lg:auto-rows-fr mt-6">
        ...
        {/* Col 2 (alto: 2 filas) */}
        <Card
          className="lg:row-span-2 max-h-[420px] overflow-hidden"
            ...
            <div className="flex flex-col gap-3 min-h-0 h-full">
              {notiLoading ? (
                ...
                <p className="text-muted-foreground text-sm">No hay notificaciones nuevas.</p>
                  ...
                  <ul className="divide-y divide-white/20 pr-2 overflow-y-auto max-h-[320px] scroll-thin overscroll-contain">
                  {localNotifs.map((n) => (
                    <li
                      key={n.id}
                      className={
