 ...
 *                     example: true
 */
router.get('/contacts', userController_1.get_all_contacts);
//-----------------------------------------------------------------------------------------------------------------
 ...
 *                   example: 17
 */
router.post('/profile', userController_1.create_usuario_profile);
//-----------------------------------------------------------------------------------------------------------------
 ...
 */
router.put('/update', userController_1.update_usuario_profile);
//-----------------------------------------------------------------------------------------------------------------
 ...
 */
router.post('/state/change', userController_1.change_state_user);
//-----------------------------------------------------------------------------------------------------------------
 ...
 */
router.post('/photo/update', userController_1.update_user_profile_photo);
//-----------------------------------------------------------------------------------------------------------------
//GET GET_STATE_USER
/**
 * @swagger
 ...
 */
router.get('/state', userController_1.get_state_user);
//-----------------------------------------------------------------------------------------------------------------
 ...
 */
router.get("/language", userController_1.get_user_language);
//-----------------------------------------------------------------------------------------------------------------
 ...
 *                   example: 3
 */
router.get("/uuid/:uuid", userController_1.get_usuario_uuid);
//-----------------------------------------------------------------------------------------------------------------
 ...
 *                   example: Femenino
 */
router.get('/:id', userController_1.get_user_by_id_usuario);
//-----------------------------------------------------------------------------------------------------------------
// GET GET_ALL_IDIOMAS
/**
 * @swagger
 ...
 *                     example: es-ES
 */
router.get('/idiomas', userController_1.get_all_idiomas);
//-----------------------------------------------------------------------------------------------------------------
// GET GET_ALL_GENEROS
/**
 * @swagger
 ...
 *                     example: Masculino
 */
router.get('/generos', userController_1.get_all_generos);
