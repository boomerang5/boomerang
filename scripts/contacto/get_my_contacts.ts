...
async function getMyContacts(p_id_usuario: number, p_busqueda?: string) {
  try {
...
const busquedaOpcional = "arga";  // o algún término como "juan"

getMyContacts(idUsuario, busquedaOpcional);